...
public class ConditionalNode extends StatementNode {
    ...
    protected void doRun(EvaluationContext context) {
        double evalLhs = lhs.doEvaluate(context);
        double evalRhs = rhs.doEvaluate(context);
        if (operator.equals(Operator.EQUALS)) {
            if (evalLhs == evalRhs) ifTrue.doRun(context);
    ...
    public void compile(PrintWriter out) {
        out.append("if(");
        lhs.compile(out);
        if (operator.equals(Operator.EQUALS)) out.append("==");
        else if (operator.equals(Operator.GREATER_THAN)) out.append(">");
        else if (operator.equals(Operator.LESS_THAN)) out.append("<");
        rhs.compile(out);
        out.append(") ");
        ifTrue.compile(out);
        out.append("else ");
